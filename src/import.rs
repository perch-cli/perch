...
/// did — a Switch it made, and when — and the cooldown is measured from it.
/// Carried across, an Export taken this morning has the first check on the new
/// machine reporting `cooling` on the strength of something that happened
/// somewhere else. That is a claim about a watcher, and no watcher has run here
/// yet.
